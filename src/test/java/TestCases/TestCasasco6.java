...
import Pasos.AniversarioCasasco;
...
//			capabilities.setCapability("platformVersion", "7.1.1");
			...
			AniversarioCasasco pAniversarioCasasco = new AniversarioCasasco();
			...
			pAniversarioCasasco.pasosAniversarioCasasco(data, report, repo, DM, iteration, name);
			pLogoutCasasco.pasosLoginCasasco(data, report, repo, DM, iteration, name);	
		
			//ADD VALIDATIONS AT THE END
			report.AddLine("Validamos que aparezca el banner de Aniversarios");
			WebDriverWait waitFor = new WebDriverWait(driver, 15);
//			result = report.validateObjectIsDisplayable(repo.get_img_aniversario());
